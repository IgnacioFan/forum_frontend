<template>
  <section>
    <div class="container py-5">
      <div class="row">
        <UserProfileCard :initial-user-profile="profile" />
        <section class="col-12 col-md-5">
          <UserFollowingsCard :initial-user-followings="followings" />
          <UserFollowersCard :initial-user-followers="followers" />
        </section>
  ...
  methods: {
    fetchUserProfile() {
      this.profile = {
        ...
        followerNumbers: dummyData.profile.Followers.length,
        followingNumbers: dummyData.profile.Followings.length,
        commentNumbers: dummyData.profile.Comments.length,
        favoriteRestaurantNumbers: dummyData.profile.FavoritedRestaurants.length
      },
